...
class CarControllerParams:
  def __init__(self, CP):
    if CP.carFingerprint in [CAR.GRANDEUR, CAR.GRANDEUR_HEV]:
      self.STEER_MAX = 409 # 409      
...
class CAR:
  ...
  GRANDEUR = "HYUNDAI GRANDEUR HYBRID 2019 2021"
  GRANDEUR_HEV = "HYUNDAI GRANDEUR HYBRID 2019 2021"
...
FEATURES = {
  ...
  "use_cluster_gears": set([CAR.GRANDEUR, CAR.ELANTRA, CAR.ELANTRA_GT_I30, CAR.KONA]),
  "use_tcu_gears": set([CAR.KIA_OPTIMA, CAR.SONATA_LF, CAR.VELOSTER]),
  "use_elect_gears": set([CAR.GRANDEUR_HEV, CAR.KIA_NIRO_EV, CAR.KIA_OPTIMA_H, CAR.IONIQ_EV_LTD, CAR.KONA_EV, CAR.IONIQ, CAR.IONIQ_EV_2020]),

  # these cars use the FCA11 message for the AEB and FCW signals, all others use SCC12
  "use_fca": set([CAR.GRANDEUR, CAR.GRANDEUR_HEV, CAR.SONATA, CAR.ELANTRA, CAR.ELANTRA_GT_I30, CAR.KIA_STINGER, CAR.IONIQ, CAR.IONIQ_EV_2020, CAR.KONA_EV, CAR.KIA_FORTE, CAR.KIA_NIRO_EV, CAR.PALISADE, CAR.GENESIS_G70, CAR.KONA, CAR.SANTA_FE, CAR.KIA_SELTOS]),
  "use_bsm": set([CAR.GRANDEUR, CAR.GRANDEUR_HEV, CAR.SONATA, CAR.PALISADE, CAR.HYUNDAI_GENESIS, CAR.GENESIS_G70,
                  CAR.GENESIS_G80, CAR.GENESIS_G90, CAR.KONA, CAR.IONIQ_EV_2020,
                  CAR.SANTA_FE, CAR.KIA_NIRO_EV, CAR.KIA_SELTOS]),
}

EV_HYBRID = set([CAR.GRANDEUR_HEV, CAR.IONIQ_EV_2020, CAR.IONIQ_EV_LTD, CAR.IONIQ, CAR.KONA_EV, CAR.KIA_NIRO_EV])
